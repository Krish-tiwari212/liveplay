...
const PreviewEventChanges: React.FC<PreviewEventChangesProps> = ({
  ...
  const handleFormSubmit = async () => {
    ...
    formData.append("venue_not_decided", EventData.venue_not_decided !== undefined ? EventData.venue_not_decided : false);
    ...
    formData.append("countdown", EventData.countdown !== undefined ? EventData.countdown : false);
    formData.append("enable_fixtures", EventData.enableFixtures !== undefined ? EventData.enableFixtures : false);
    formData.append(
      "eventData",
      JSON.stringify({
