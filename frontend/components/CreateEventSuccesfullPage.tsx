...
const CreateEventSuccesfullPage = () => {
    ...
    <div className="flex justify-center items-center flex-col py-6 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center my-8">
          <h1 className="text-2xl sm:text-3xl font-semibold">Successful</h1>
          <p className="text-sm sm:text-base">
            Congrats, you’ve successfully Created the event!
          </p>
        </div>
...
export default CreateEventSuccesfullPage;
