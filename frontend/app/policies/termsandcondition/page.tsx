...
Players may withdraw from an event or event category after successful registration and payment, provided that the withdrawal is initiated immediately after registration but no later than the last day to withdraw as specified by the event organizer.
To initiate the withdrawal, players must access the withdrawal option in the registration panel within the event card, available in their player dashboard. From there, players can select the specific event categories they wish to withdraw from.
Refunds will only be available if the player has opted for the withdrawal fee at the time of registration, amounting to 5% of the registration fee. In such cases, the withdrawal fee is non-refundable.
Upon receipt of a valid withdrawal request, liveplay.in shall initiate the refund process within 5-7 working days, and the amount will be credited to the player's bank account. Please note that the refund will not include the optional 5% withdrawal fee.
In the event of an organizer's cancellation of an event, all registered players are entitled to a full refund of the registration fee, which will be initiated within 7 business days. If an organizer fails to conduct an event without prior notice or proper cancellation, a refund will be provided to all registered players after deduction of the applicable cancellation fee. Should the organizer fail to pay this cancellation fee, resulting in the burden falling on the players, the organizer will be prohibited from hosting any future events on the platform. Strict action will be taken in such circumstances.
`,
  },
  {
...
Organizers may cancel an event at any time by accessing the event management panel in their organizer dashboard, selecting the "Cancel Event" option and paying the applicable cancellation fee. The cancellation fee is mandatory for all event cancellations where player registrations have taken place. In cases where no player registrations have occurred, organizers may cancel the event without any fee.
The cancellation fee will be calculated on the "net event sales," which is defined as the gross registration fee for the event, less any discounts or refunds issued. The cancellation fee for standard organizers is 7.5% of net event sales, while for Elite organizers, it is 5%.
Failure to pay the cancellation fee will result in the inability to cancel the event. If an organizer attempts to cancel without fee payment, the event will remain active, and participants may hold the organizer accountable if the event does not take place.
In the case of non-performance—where an event is not conducted on the scheduled date without proper cancellation—a cancellation fee of 7.5% will be imposed, and player refunds will be processed. Should the organizer fail to pay this cancellation fee, the fee will be deducted from the participant's registration fees. In such situations, the organizer will be debarred from hosting any future events on the platform, and strict action will be taken.
For events canceled by organizers, participant refunds will be initiated and processed within 5-7 working days from the date of event cancellation.`,
  },
  {
  ...
  return (
    <div className="py-8 px-4 md:py-12 md:px-20">
      ...
      <p className="mb-2  text-md md:text-xl">
        Last updated on 22-11-2024 11:27:01
      </p>
      <p className="mb-2  text-md md:text-xl">
