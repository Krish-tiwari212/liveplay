        ...
        <div className="my-4 w-full">
          <div className="border-2 border-gray-800 p-2 md:p-5 rounded-lg">
            <div className="flex flex-col mb-1">
              {/* Uncomment and adjust when cart items are available */}
              {/* {items.length === 0 ? (
              ...
              >
                <div className="flex flex-1 gap-1 items-center">
                  ...
                  <p className="md:text-sm text-gray-600">Quantity: x1</p>
                </div>
                <div className="text-right flex-1 flex justify-end gap-2 items-end sm:items-center ">
                  <p className="text-sm line-through text-gray-500">₹12,345</p>
                  <p className="text-green-600 font-semibold">₹12,345</p>
                </div>
              </div>
              {/* ))
              )} */}
